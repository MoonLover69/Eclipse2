...
{
    class TutorialModule : GameModule
    {
        private TypewriterDisplay _text;
        private int _moduleIndex = 0;

        public TutorialModule(Game parent, ComponentPanel upper, ComponentPanel lower)
        ...
        private void AdvanceText()
        {
            switch (_moduleIndex)
            {
                case 0:
                {
                    _text.AddText(TutorialStrings.TutorialString01);
                    break;
                }
                default:
                {
